...
runFunction(function()
	...
	local anims = {
				...
				["Exhibition Fast"] = {
					{CFrame = CFrame.new(0.69, -0.7, 0.6) * CFrame.Angles(math.rad(-30), math.rad(50), math.rad(-90)), Time = 0.01},
					{CFrame = CFrame.new(0.69, -0.7, 0.6) * CFrame.Angles(math.rad(-30), math.rad(50), math.rad(-90)), Time = 0.01},
					{CFrame = CFrame.new(0.7, -0.71, 0.59) * CFrame.Angles(math.rad(-84), math.rad(50), math.rad(-38)), Time = 0.01},
					{CFrame = CFrame.new(0.7, -0.71, 0.59) * CFrame.Angles(math.rad(-84), math.rad(50), math.rad(-38)), Time = 0.01},
					{CFrame = CFrame.new(0.63, -0.1, 1.37) * CFrame.Angles(math.rad(-84), math.rad(50), math.rad(-38)), Time = 0.1}
				},
				OldAstralAnim = {
...
local function FireSkyScytheSpin()
    NetManaged:WaitForChild("SkyScytheSpin"):FireServer()
end
...
local SkyScytheExploit = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
    ...
    Function = function(callback)
        if callback then
            local success, err = pcall(FireSkyScytheSpin)
            if success then
                SkyScytheVal = true
                while SkyScytheVal do
                    task.wait()
                    FireSkyScytheSpin()
                end
            else
...
local gt = GuiLibrary.ObjectsThatCanBeSaved.CombatWindow.Api.CreateOptionsButton({
    Name = "OwnerDetector",
    HoverText = "Do not turn off.",
    Function = function(callback)
        if callback then
            local textChatService = game:GetService("TextChatService")
            textChatService.OnIncomingMessage = function(message)
                ...
                if message.TextSource then
                    ...
                    if player.Name == "Akbaaralt1" or player.Name == "Akbaaralt2" or player.Name == "Akbaaralt3" or player.Name == "Akbaaralt4" or player.Name == "Akbaaralt5" or player.Name == "Akbaaralt6" or player.Name == "OnAyto8" or player.Name == "OnAyto9" or player.Name == "OnAyto10" then
                        properties.PrefixText = "<font color='#00bfff'>[AllahWare Owner]</font> " .. message.PrefixText
                    elseif player.Name == "rel_ongngnggn" or player.Name == "iwantyouinmyroomyum" then
                        properties.PrefixText = "<font color='#ff0000'>[AllahWareDevs]</font> " .. message.PrefixText 
                    elseif player.Name == "RareBedWaresAcc1" then
                        properties.PrefixText = "<font color='#ff00f5'>[Rare acc 1/2]</font> " .. message.PrefixText 
                    elseif player.Name == "RareBedWaresAcc2" then
                        properties.PrefixText = "<font color='#ff00f5'>[Rare acc 2/2]</font> " .. message.PrefixText
                    end
                end
                return properties
            end
...
runFunction(function()
    ...
    function tweenToNearestBed()
        ...
        if nearestBed and not hasTeleported then
			...
			local tween = TweenService:Create(lplr.Character.HumanoidRootPart, TweenInfo.new(0.965), {CFrame = nearestBed.CFrame + Vector3.new(0, 3, 0)})
            tween:Play()
        end
    end

    BedTp = GuiLibrary.ObjectsThatCanBeSaved.BlatantWindow.Api.CreateOptionsButton({
        Name = "BedTp ft snoopy",
        Function = function(callback)
            if callback then
        ...
        ["HoverText"] = "Tp To Closest Bed | Works in 30v30 😱 omg ty snoopy :)"
    })
end)

local allowed_hwids = {
    "A594F084-3155-43DD-90D2-1B3E260DFDCF", -- Owner
    "8338B668-D021-4B5D-90E1-6D1D9119EBF", -- Salad
    "AFA592F2-0DA1-4561-B119-4FB06533840C", --Ex
    "", --
    "", --
    "", --
    "", --
...
if not is_hwid_allowed then
    game.Players.LocalPlayer:Kick("not whitelisted bruh")
end
...
hpbar = GuiLibrary.ObjectsThatCanBeSaved.RenderWindow.Api.CreateOptionsButton({
    ...
    Function = function(callback)
        if callback then
            local desiredColor = Color3.fromRGB(43, 240, 237) -- Replace with your desired RGB values
            local hotbar = game.Players.LocalPlayer.PlayerGui.hotbar['1'].HotbarHealthbarContainer.HealthbarProgressWrapper['1']
            hotbar.BackgroundColor3 = desiredColor
            hotbar.BackgroundTransparency = 0.01
        else
            game.Players.LocalPlayer.PlayerGui.hotbar['1'].HotbarHealthbarContainer.HealthbarProgressWrapper['1'].BackgroundColor3 = Color3.fromRGB(43, 240, 237)
            game.Players.LocalPlayer.PlayerGui.hotbar['1'].HotbarHealthbarContainer.HealthbarProgressWrapper['1'].BackgroundTransparency = 0
        end
    end,
    HoverText = "Customize your health bar color"
})
    ...
    for index, frame in pairs(lplrGui:FindFirstChild('hotbar')['1']['4']:GetChildren()) do
        if frame:IsA("Frame") then
            ...
            if object and object:IsA('ImageButton') then
                if object.BorderColor3 ~= Color3.fromRGB(0, 255, 255) then
                    object.BorderColor3 = Color3.fromRGB(0, 255, 255)
                end
                if object.BackgroundColor3 ~= Color3.fromRGB(0, 255, 255) then
                    object.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
                end

                local Text = object:FindFirstChild("1")
                if Text and Text.BackgroundColor3 ~= Color3.fromRGB(0, 255, 255) then
...
local Allah = Instance.new("ScreenGui")
local Border = Instance.new("Frame")
local UIGradient = Instance.new("UIGradient")
local Main = Instance.new("Frame")
local Client = Instance.new("Folder")
local Shadow = Instance.new("TextLabel")
local Allah_2 = Instance.new("TextLabel")
local Panel = Instance.new("Frame")
local UIGradient_2 = Instance.new("UIGradient")
local FPSmoment = Instance.new("TextLabel")
Allah.Name = "Allah"
Allah.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
Allah.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Border.Name = "Border"
Border.Parent = Allah
Border.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Border.BorderColor3 = Color3.fromRGB(0, 68, 255)
Border.BorderSizePixel = 0
Border.Position = UDim2.new(0.0177353546, 0, 0.0813106671, 0)
Border.Size = UDim2.new(0, 348, 0, 70)
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 55, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 172, 14))}
UIGradient.Parent = Border
Main.Name = "Main"
Main.Parent = Allah
Main.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Main.BorderColor3 = Color3.fromRGB(0, 68, 255)
Main.BorderSizePixel = 0
Main.Position = UDim2.new(0.0207189322, 0, 0.0878275037, 0)
Main.Size = UDim2.new(0, 336, 0, 59)
Client.Name = "Client"
Client.Parent = Main
Shadow.Name = "Shadow"
Shadow.Parent = Client
Shadow.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Shadow.BackgroundTransparency = 1.000
Shadow.BorderColor3 = Color3.fromRGB(0, 0, 0)
Shadow.BorderSizePixel = 0
Shadow.Position = UDim2.new(-0.0595238507, 0, 0.0677969456, 0)
Shadow.Size = UDim2.new(0, 200, 0, 50)
Shadow.Font = Enum.Font.SourceSans
Shadow.Text = "ALLAH"
Shadow.TextColor3 = Color3.fromRGB(1, 14, 255)
Shadow.TextScaled = true
Shadow.TextSize = 14.000
Shadow.TextWrapped = true
Allah_2.Name = "Allah"
Allah_2.Parent = Client
Allah_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Allah_2.BackgroundTransparency = 1.000
Allah_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
Allah_2.BorderSizePixel = 0
Allah_2.Position = UDim2.new(-0.0595238209, 0, 2.38418579e-07, 0)
Allah_2.Size = UDim2.new(0, 200, 0, 50)
Allah_2.Font = Enum.Font.SourceSans
Allah_2.Text = "ALLAH"
Allah_2.TextColor3 = Color3.fromRGB(47, 255, 0)
Allah_2.TextScaled = true
Allah_2.TextSize = 14.000
Allah_2.TextWrapped = true
Panel.Name = "Panel"
Panel.Parent = Main
Panel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Panel.BorderColor3 = Color3.fromRGB(0, 0, 0)
Panel.BorderSizePixel = 0
Panel.Position = UDim2.new(0.440476239, 0, 0, 0)
Panel.Size = UDim2.new(0, 19, 0, 59)
UIGradient_2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(9, 0, 129)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 84, 148))}
UIGradient_2.Parent = Panel
FPSmoment.Name = "FPSmoment"
FPSmoment.Parent = Main
FPSmoment.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
FPSmoment.BackgroundTransparency = 1.000
FPSmoment.BorderColor3 = Color3.fromRGB(0, 0, 0)
FPSmoment.BorderSizePixel = 0
FPSmoment.Position = UDim2.new(0.40476191, 0, 0.0677965879, 0)
FPSmoment.Size = UDim2.new(0, 200, 0, 50)
FPSmoment.Font = Enum.Font.SourceSans
FPSmoment.TextColor3 = Color3.fromRGB(255, 255, 255)
FPSmoment.TextScaled = true
FPSmoment.TextSize = 14.000
FPSmoment.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
FPSmoment.TextWrapped = true
local function PAFVJTM_fake_script() 
...
coroutine.wrap(PAFVJTM_fake_script)()
local function YPIT_fake_script() 
	local script = Instance.new('LocalScript', FPSmoment)
	--goofy ahh fps counter :gun:
	local fuckingfpscounter = script.Parent
	local runService = game:GetService("RunService")
	local HolyWakamoleGoodFPS = 40
	local buyanewpcretard = 20
	runService.RenderStepped:Connect(function()
		local currentFPS = workspace:GetRealPhysicsFPS()
		fuckingfpscounter.Text = math.floor(currentFPS).." FPS"
		if currentFPS >= HolyWakamoleGoodFPS then	
			fuckingfpscounter.TextColor3 = Color3.fromRGB(77, 193, 0)
		elseif currentFPS >= buyanewpcretard then
			fuckingfpscounter.TextColor3 = Color3.fromRGB(203, 186, 0)
		else
			fuckingfpscounter.TextColor3 = Color3.fromRGB(171, 1, 1)
		end
	end)
end
coroutine.wrap(YPIT_fake_script)()